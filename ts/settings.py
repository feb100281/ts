...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        # permissions — jazzmin прячет пункт от того, у кого права нет.
        # Те же права проверяются на самих адресах (ts/urls.py, export_view),
        # иначе ссылку можно было бы просто набрать руками.
        {"name": "Запустить GL ETL", "url": "run_gl_etl", "new_window": False,
         "permissions": ["gear.export_gl"]},
