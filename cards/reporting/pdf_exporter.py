...
# def build_missing_fields_pdf_response(stats, upd_list=None, missing_nm_by_upd=None, missing_chrt_by_upd=None, vat_mismatch_by_upd=None):
...
#     missing_nm_percent = 0
#     missing_chrt_percent = 0
#     vat_mismatch_percent = 0
    
#     if total_amount > 0:
#         missing_nm_percent = round(stats.get('missing_nm_amount', 0) / total_amount * 100, 1)
#         missing_chrt_percent = round(stats.get('missing_chrt_amount', 0) / total_amount * 100, 1)
#         vat_mismatch_percent = round(stats.get('vat_mismatch_amount', 0) / total_amount * 100, 1)
...
#         # Статистика по НДС
#         'vat_mismatch_count': stats.get('vat_mismatch_count', 0),
#         'vat_mismatch_qty': stats.get('vat_mismatch_qty', 0),
#         'vat_mismatch_amount': stats.get('vat_mismatch_amount', 0),
#         'vat_mismatch_percent': vat_mismatch_percent,
        
#         # Список УПД и распределение проблем
#         'upd_list': upd_list or [],
#         'missing_nm_by_upd': missing_nm_by_upd or [],
#         'missing_chrt_by_upd': missing_chrt_by_upd or [],
#         'vat_mismatch_by_upd': vat_mismatch_by_upd or [],
#     }
...
def build_missing_fields_pdf_response(stats):
