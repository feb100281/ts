...
#     # если формат типа 40,220,861.19
...
#         excel_path = (
#             "/Users/daria/Desktop/New.xlsx"
#         )

#         output_path = (
#                 "/Users/daria/Desktop/upd_reconciliation_result.xlsx"
#             )

#         self.stdout.write(f"Читаю файл 1С: {excel_path}")

#         # Заголовки начинаются с 4 строки
#         df_1c = pd.read_excel(
#             excel_path,
#             header=3,
#         )
...
#                 "counterparty_norm": normalize_counterparty_name(
#                     counterparty_name
#                 ),
#                 "date": upd.date,
#                 "number_norm": normalize_number(
#                     upd.number
#                 ),
