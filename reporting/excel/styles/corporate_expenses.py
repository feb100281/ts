# reporting/excel/styles/corporate_expenses.py
...
def _draw_header(ws, date_to=None):
    ...
    draw_sheet_header(
        ws,
        title="1.5 КОРПОРАТИВНЫЕ РАСХОДЫ (G&A)",
        subtitle=subtitle,
        currency=currency,
    )
...
def style_corporate_expenses_sheet(ws, payload, date_to=None):
    _clear_sheet(ws)
