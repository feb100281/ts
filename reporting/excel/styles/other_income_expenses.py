# reporting/excel/styles/other_income_expenses.py
...
def _draw_header(ws, date_to=None):
    ...
    draw_sheet_header(
        ws,
        title="1.6 ПРОЧИЕ ДОХОДЫ И РАСХОДЫ",
        subtitle=subtitle,
        currency=currency,
    )
...
def style_other_income_expenses_sheet(ws, payload, date_to=None):
    _clear_sheet(ws)
