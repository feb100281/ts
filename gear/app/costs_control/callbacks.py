...
from .modal import register_chart_product_modal_callbacks
from .article_report import register_article_report_callbacks
...
def register_costs_control_callbacks(
    ...
    register_article_report_callbacks(app)