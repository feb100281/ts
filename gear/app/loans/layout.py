                        ...
                        children=[
                            ...
                            html.Div(
                                children=[
                                    ...
                                    html.Div(
                                        (
                                            "Обязательства по полученным займам и "
    ...
    return html.Div(
        children=[
            html.Div(
                ...
                children=[
                    chart_panel(
                        title="Обязательства и требования",
                        subtitle=(
                            "Мы должны, нам должны и чистая позиция"
                        ),
              graph=dcc.Graph(
                    id=DEBT_DYNAMICS_CHART_ID,
                    figure=_empty_figure(),
                    ...
                    chart_panel(
                            title="Позиция по контрагентам",

                            subtitle=(
                                "Кому должны мы и кто должен нам"
                            ),
                    ...
                    chart_panel(
                        title="Сроки платежей и поступлений",

                        subtitle=(
                            "К оплате по полученным и к получению по выданным"
                        ),
                    ...
                    chart_panel(
                        ...
                        subtitle=(
                            "Процентный расход и доход показаны раздельно"
                        ),
