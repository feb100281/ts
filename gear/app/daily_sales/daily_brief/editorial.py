...
def build_editorial(
    ...
    if stocks.get("available"):
        ...
        stock = (
            ...
            "общего запаса. Высокая доля товара в пути снижает объём немедленно "
            "доступного запаса и увеличивает зависимость результата от скорости "
            "приёмки, возврата товара на склад и регионального распределения."
        )
