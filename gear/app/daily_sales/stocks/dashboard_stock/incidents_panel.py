...
def _incident_card(
    ...
    Для события рассчитывается исторический снимок:
    ...
    return dmc.Paper(
        ...
        children=[
            ...
            html.Div(
                style={
                    # ---------------------------------------------------------
                    # Максимальная высота блока событий
                    # ---------------------------------------------------------

                    "maxHeight": "520px",

                    # ---------------------------------------------------------
                    # Вертикальный scroll появляется только когда нужен
                    # ---------------------------------------------------------

                    "overflowY": "auto",

                    # ---------------------------------------------------------
                    # Горизонтальный scroll запрещаем
                    # ---------------------------------------------------------
                    ...
                    # ---------------------------------------------------------
                    # Чтобы ширина контента не прыгала
                    # при появлении scrollbar
                    # ---------------------------------------------------------
