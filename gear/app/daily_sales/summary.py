...
# def _kpi(title, value, note, icon, color="blue"):
#     return dmc.Box(
#         style={
...
#     margin_percent = _safe_div(margin_man, amount_vatless) * 100
#     cogs_percent = _safe_div(cogs_man, amount_vatless) * 100
...
#                             "Упр. маржа",
#                             _money(margin_man),
#                             f"маржинальность: {_pct(margin_percent)}",
#                             "solar:graph-up-linear",
#                             "green" if margin_man >= 0 else "red",
#                         ),
#                         span={"base": 12, "md": 6, "xl": 3},
#                     ),
#                     dmc.GridCol(
...
#                             "Комиссия WB",
#                             _money(commission),
#                             f"доля комиссии: {_pct(commission_percent)}",
...
#                             "Маржинальность",
#                             margin_percent,
#                             f"{_pct(margin_percent)} / {_money(margin_man)}",
...
#                             "Управленческая с/с",
#                             cogs_percent,
#                             f"{_pct(cogs_percent)} / {_money(cogs_man)}",
#                             "blue",
#                         ),
#                         span={"base": 12, "md": 4},
#                     ),
